...
//                 {['AI', 'Writing', 'Code', 'Business', 'Creative', 'Marketing', 'Academic'].map((tag) => (
//                   <button
//                     key={tag}
//                     onClick={() => setFilterTag(tag === filterTag ? '' : tag)}
//                     className={` mx-2 px-2 py-1 rounded-full text-sm transition-all ${
//                       filterTag === tag 
...
//               </div> */}
//               <div className="flex flex-wrap gap-2">
//                {['AI', 'Writing', 'Code', 'Business', 'Creative'].map((tag) => (
//                 <button
//                   key={tag}
...
//                       <div className="h-5 w-5 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 flex items-center justify-center overflow-hidden">
              ...
              <div className="space-y-4">
                {topUsers.map((contributor) => (
                  <div key={contributor.id} className="bg-gray-50 rounded-lg p-3">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                      <div className="h-7 w-7 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 flex items-center justify-center overflow-hidden gap-2">
                        <img src={contributor.profilePicture || "https://res.cloudinary.com/djncnauta/image/upload/v1735364671/profile_photo_gaqfit.jpg"} className="h-full w-full object-cover"/>
                      </div>
                        <span className="text-sm font-medium text-gray-900">{contributor.name}</span>
                      </div>
